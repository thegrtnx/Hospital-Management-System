                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 mb-4 order-0">
                          ...
                          <div class="card-body">
                                  ...
                                  <h3 class="card-title mb-2">Review/Approve <br/> Appointments</h3>
                                  <small class="text-dark fw-semibold">Resolve pending appointments <i class="bx bx-right-arrow-alt"></i></small>
                                </div>
                          </div>
                          </a>
                        ...
                        <div class="col-lg-6 mb-4 order-0">
                          ...
                          <div class="card-body">
                                  ...
                                  <h3 class="card-title mb-2">Upload Drugs to <br/> Pharma Center  </h3>
                                  <small class="text-dark fw-semibold">Upload available drugs for the pharmacy <i class="bx bx-right-arrow-alt"></i></small>
                                </div>
                          </div>
                          </a>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 mb-4 order-0">
                        ...
                        <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">All Registered Patients <br/></h3>
                                <small class="text-dark fw-semibold">View and purchase available drugs <i class="bx bx-right-arrow-alt"></i></small>
                              </div>
                        </div>
                        </a>
                      ...
                      <div class="col-lg-6 mb-4 order-0">
                        ...
                        <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">All Registered Nurses) and Doctor(s) </h3>
                                <small class="text-dark fw-semibold">S(chedule a meet with a doctor <i class="bx bx-right-arrow-alt"></i></small>
                              </div>
                        </div>
                        </a>
